# Proposed Studios and Capstone

> **Note:** This document describes proposed applied studios and capstone experiences. Course content, infrastructure, and partnerships would be finalized upon program approval.

## Applied Studios (A²I 621–623)

Each studio would be an 8-week, project-intensive experience that would immerse learners in the practice of orchestrating intelligent systems on Google Cloud infrastructure with open collaboration in GitHub.【F:docs/context/conversation.md†L56-L124】
...
### Purpose
Learners would synthesize program threads by delivering an authentic system that advances public or organizational value while demonstrating governance, entrepreneurship, and reflexive practice.【F:docs/context/conversation.md†L135-L177】
